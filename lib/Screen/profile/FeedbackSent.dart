...
class FeedbackSent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //           children: <Widget>[
      //             Pinned.fromSize(
      //               bounds: Rect.fromLTWH(89.0, 0.0, 64.0, 64.0),
      //               size: Size(244.0, 163.0),
      //               pinTop: true,
      //               fixedWidth: true,
      //               fixedHeight: true,
      //               child: Stack(
      ...
      //             ),
      //             Pinned.fromSize(
      //               bounds: Rect.fromLTWH(37.0, 88.0, 168.0, 24.0),
      //               size: Size(244.0, 163.0),
      //               fixedWidth: true,
      //               fixedHeight: true,
      //               child: Text(
      ...
      //             ),
      //             Pinned.fromSize(
      //               bounds: Rect.fromLTWH(0.0, 144.0, 244.0, 19.0),
      //               size: Size(244.0, 163.0),
      //               pinLeft: true,
      //               pinRight: true,
      //               pinBottom: true,
